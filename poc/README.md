...
| 地址 | 是什么 |
|---|---|
| <http://localhost:8000> | Web 界面：提需求、看进度、拿链接 |
| <http://localhost:8081> | 做好的站点，按项目名分目录 |
| <http://localhost:3000> | Gitea，看代码和 CI 记录，账号 `cloudide` / `cloudide-poc-2026` |
